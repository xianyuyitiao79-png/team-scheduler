        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
                ...
                disabled={!isAdmin}
                className={`mt-1 block w-full px-3 py-2 border border-zinc-300 rounded-md shadow-sm focus:outline-none focus:ring-zinc-500 focus:border-zinc-500 sm:text-sm ${!isAdmin ? 'bg-zinc-100 text-zinc-500 cursor-not-allowed' : ''}`}
            >
                {profiles.map(p => (
